...
#The random library allows for use in selecting a random number later
import random
def randomBisect():
    ...
    the_place = random.randrange(0,25)
    #this relates this index to the letter equivelant
    my_guess = the_alphabet[the_place]
    #print the first(random) guess and ask the user if their value is the same, higher or lower
